import type { DurableObjectStorage, ExecutionContext as CFExecutionContext, WebSocket, Request as CFRequest } from "@cloudflare/workers-types";
...
export type Worker = ServerConstructor & {
     ...
     * state.
     **/
    onFetch?(req: Request, lobby: FetchLobby, ctx: ExecutionContext): Response | Promise<Response>;
    /**
     ...
     */
    onBeforeRequest?(req: Request, lobby: Lobby, ctx: ExecutionContext): Request | Response | Promise<Request | Response>;
    /**
     ...
     */
    onBeforeConnect?(req: Request, lobby: Lobby, ctx: ExecutionContext): Request | Response | Promise<Request | Response>;
};
/**
...
export type PartyKitServer = {
    ...
    unstable_onFetch?: (req: Request, lobby: FetchLobby, ctx: ExecutionContext) => Response | Promise<Response>;
    onFetch?: (req: Request, lobby: FetchLobby, ctx: ExecutionContext) => Response | Promise<Response>;
    onBeforeRequest?: (req: Request, party: {
        id: string;
        env: Record<string, unknown>;
        parties: Context["parties"];
    }, ctx: ExecutionContext) => ReturnRequest | Response | Promise<ReturnRequest | Response>;
    onRequest?: (req: Request, party: Party) => Response | Promise<Response>;
    onAlarm?: (party: Omit<Party, "id" | "parties">) => void | Promise<void>;
    onConnect?: (connection: Connection, party: Party, ctx: ConnectionContext) => void | Promise<void>;
    onBeforeConnect?: (req: Request, party: {
        id: string;
        env: Record<string, unknown>;
        parties: Context["parties"];
    }, ctx: ExecutionContext) => ReturnRequest | Response | Promise<ReturnRequest | Response>;
     ...
     */
    onMessage?: (message: string | ArrayBuffer | ArrayBufferView, connection: Connection, party: Party) => void | Promise<void>;
    onClose?: (connection: Connection, party: Party) => void | Promise<void>;
    onError?: (connection: Connection, err: Error, party: Party) => void | Promise<void>;
};
